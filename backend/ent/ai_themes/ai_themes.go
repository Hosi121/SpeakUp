...
const (
	// Label holds the string label denoting the ai_themes type in the database.
	Label = "ai_themes"
	...
	EdgeUsed = "used"
	// Table holds the table name of the ai_themes in the database.
	Table = "ai_theme_ss"
	// UsedTable is the table that holds the used relation/edge.
	UsedTable = "event_ss"
	// UsedInverseTable is the table name for the EVENTS entity.
	// It exists in this package in order to avoid circular dependency with the "events" package.
	UsedInverseTable = "event_ss"
	// UsedColumn is the table column denoting the used relation/edge.
	UsedColumn = "events_uses"
)

// Columns holds all SQL columns for ai_themes fields.
var Columns = []string{
	FieldID,
	FieldThemeText,
	FieldCreatedAt,
...
// OrderOption defines the ordering options for the AI_THEMES queries.
